...
var HyperSixteen = function () {
  ...
  _createClass(HyperSixteen, [{
    ...
    value: function decorateConfig(config) {
      ...
      var backgroundColor = config.backgroundColor || base16.base00;
      var darkBackgroundColor = this.shade(backgroundColor, -0.4);
      var foregroundColor = config.foregroundColor || ansi.white;
      var cursorColor = config.cursorColor || ansi.white;
      var borderColor = config.borderColor || darkBackgroundColor;
